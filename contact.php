            ...
            <div class="row">
               <div class="col-md-12 ">
                  <div class="titlepage">
                     ...
                     <span style="text-align: center;">081234567890</span>
                  </div>
               </div>
            </div>
         </div>
                  ...
                  <div class="row">
                     <div class="col-sm-4">
                       <div class="site_info">
                          ...
                          <span style="margin-top: 10px;">Jl. Ketintang, Ketintang, Kec. Gayungan, Kota SBY, Jawa Timur 60231</span></div>
                     </div>
                     <div class="col-sm-4">
                       <div class="site_info">
                          <span class="info_icon"><img src="images/phone-icon.png" /></span>
                          <span style="margin-top: 21px;">( 081234567890 )</span></div>
                     </div>
                     <div class="col-sm-4">
                       <div class="site_info">
